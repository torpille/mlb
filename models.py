...
class Game(Base):
    ...
    visiting_pitcher_2019_season_era= Column(String(200), nullable=True)
    visiting_pitcher_2019_season_wl= Column(String(200), nullable=True)
    visiting_pitcher_2019_season_so= Column(String(200), nullable=True)
    visiting_pitcher_2019_season_whip= Column(String(200), nullable=True)
    visiting_pitcher_career_era= Column(String(200), nullable=True)
    visiting_pitcher_career_wl= Column(String(200), nullable=True)
    visiting_pitcher_career_so= Column(String(200), nullable=True)
    visiting_pitcher_career_whip= Column(String(200), nullable=True)
    ...
    home_pitcher_2019_season_era= Column(String(200), nullable=True)
    home_pitcher_2019_season_wl= Column(String(200), nullable=True)
    home_pitcher_2019_season_so= Column(String(200), nullable=True)
    home_pitcher_2019_season_whip= Column(String(200), nullable=True)
    home_pitcher_career_era= Column(String(200), nullable=True)
    home_pitcher_career_wl= Column(String(200), nullable=True)
    home_pitcher_career_so= Column(String(200), nullable=True)
    home_pitcher_career_whip= Column(String(200), nullable=True)
